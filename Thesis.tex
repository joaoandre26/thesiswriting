...
\usepackage{lipsum}
\usepackage[backend=biber, sorting=none, url=false]{biblatex} % --Z Uncomment to put references at the end of the document
%\usepackage[backend=biber, refsection=chapter, sorting=none, url=false]{biblatex}  %--> Uncomment to put the references at the end of chapter 
...
\include{Chapters/1CHP/chapter1}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AV1 Video Codec
\include{Chapters/2CHP/chapter2}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AV1 Video Codec
\include{Chapters/3CHP/chapter3}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Developed Architecture
\include{Chapters/4CHP/chapter4}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Developed Architecture
\include{Chapters/5CHP/chapter5}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Tests, Results and Analysis
\include{Chapters/6CHP/chapter6}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Final Remarks
\include{Chapters/7CHP/chapter7}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Developed Architecture
%\include{Sections/Annex/appendix}

...
%%Section To do
\todo[inline,color=red!40]{*Order the section in this chapter}
...
\todo[inline,color=blue!20]{*Pressure based device - add the problems of this method}
...
\end{figure}
\subsection{Don't know yet} %% Should put in the introduction of the next chapter this????????
...
\section{Sensors}\label{sec:VibSens}

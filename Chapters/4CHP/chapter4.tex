...
\todo[inline,color=blue!40]{*1 - Selection}
\todo[inline,color=blue!40]{ a) Microphone}
\todo[inline,color=blue!40]{ b) Accelerometer}
\todo[inline,color=red!40]{ c) Piezoelectric}
\todo[inline,color=yellow!40]{ d) Microcontroller}
\todo[inline,color=yellow!40]{ e) Solenoid}

\todo[inline,color=yellow!40]{*2 - Design}
\todo[inline,color=red!40]{ a) Accelerometer}
\todo[inline,color=yellow!40]{ b) Piezoelectric}
\todo[inline,color=yellow!40]{ c) Solenoid}
\todo[inline,color=yellow!40]{*3 - Capture/Coupling}

\todo[inline,color=yellow!40]{ a) Microphone}
\todo[inline,color=yellow!40]{ b) Accelerometer}

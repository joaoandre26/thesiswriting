...
\todo[inline,color=yellow!40]{*1-System Elements}
\todo[inline,color=blue!40]{     *1-The sensors/Actuator}
\todo[inline,color=blue!40]{     *2-The processing Unit}
\todo[inline,color=yellow!40]{     *3-Processing type}
\todo[inline,color=red!40]{*2-Architecture proposal}
\todo[inline,color=red!40]{*3-Approach to the problem}
